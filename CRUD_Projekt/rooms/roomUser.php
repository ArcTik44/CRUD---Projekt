...
final class RoomDetailUser extends BaseDBPage
{
    private ?int $room_id;
    ...
    protected function body(): string
    {
        ...
        if (!$this->room_id) {
            ...
            $stmt = $this->pdo->prepare("SELECT name, no, phone FROM room WHERE room_id =:roomId");
        ...
        return $this->m->render("roomDetailUser", ["room" => $stmt, 'keys' => $stmtKeys, 'employees' => $stmtEmp, 'AVG' => $queryAvg]);
    }
}
$page = new RoomDetailUser();
$page->render();
